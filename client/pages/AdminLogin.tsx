      ...
      <div className="relative w-full max-w-md">
        ...
        <Card className="p-8 shadow-lg bg-slate-800 border-slate-700">
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            {localError && (
              <div className="p-3 bg-red-900/50 border border-red-500 rounded-lg text-sm text-red-200 mb-4">
                {localError}
              </div>
            )}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <Input
                  type="email"
                  placeholder="admin@printsociety.co"
                  value={email}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 pr-10 bg-slate-900 border-slate-700 text-white placeholder:text-slate-600 focus:ring-blue-500"
                  disabled={isLoading}
                  required
                />
                <button
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full mt-6 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:opacity-50 transition font-medium flex items-center justify-center gap-2"
            >
